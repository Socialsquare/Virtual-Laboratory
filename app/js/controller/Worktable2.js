    ...
    var Worktable2 = BaseViewController.extend({
        ...
        constructor: function () {
            ...
            self.renderTable = function () {
		        var worktable2 = gameState.worktable2(),
	        ...
	        self.renderCentrifuge = function () {
		        var worktable2 = gameState.worktable2(),
	        ...
	        self.handleDropOnCentrifuge = function (view, $centrifuge, $draggable) {
		        var worktable2 = gameState.worktable2(),
			        top, left;
	        ...
	        self.handleDropOnOD = function (view, $OD, $draggable) {
		        var worktable2 = gameState.worktable2(),
			        $display, content;
	        ...
	        self.toggleBlender = function (event) {
		        var $blender = $(this);
